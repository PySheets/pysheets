...
names = [
    ...
    "hide_header", "mousemove", "popup", "show_account_menu", 
    ...
    "to_dict", "load_images", "remove_arrows", "load_cells", "draw_arrows",
    "load_data", "update_editor", "remove_old_editors", "save_file", "save_done",
    ...
    "ignore", "message", "td", "buttons", "local_storage",
    "remove_marker", "summarize_edit", "changed_cells", "get_timestamp",
